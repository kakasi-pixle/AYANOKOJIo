...
let teks = `*❒═[لقد حصل بوت ايانوكوجي على تقييم]═❒*\n\n*❒ الــتـقـــيـم : [ ${text} ]*\n*❒ بـواسـطـة : [ +${m.sender.split`@`[0]} ]*\n\n*❒══[اتمنى ان يكون قد اعجبك]═══❒*`
conn.reply('201211231685@s.whatsapp.net', m.quoted ? teks + m.quoted.text : teks, null, { contextInfo: { mentionedJid: [m.sender] }})
